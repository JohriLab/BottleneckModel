# BottleneckModel
Files of note: 
-simulation/bottleneck_simulation.py runs the simulation
...
markov_process/ contains code for numerically solving for the times to coalescence via first step analysis. Contains a backwards-in-time simulation for the bottleneck coalescent process where the number of samples n > 2.
