...
python "${SCRIPT_DIR}/simple_analyze_tree_sim.py" \
  --grid --yscale linear --output "${SCRIPT_DIR}/plots/sfs_grid_8panel.pdf" --input-file "${SCRIPT_DIR}/../sfs_simulation/simulation_results.jsonl" \
...
python "${SCRIPT_DIR}/simple_analyze_tree_sim.py" \
  --grid --yscale log --output "${SCRIPT_DIR}/plots/sfs_grid_8panel_logy.pdf" --input-file "${SCRIPT_DIR}/../sfs_simulation/simulation_results.jsonl" \
  --panel 5000 5000 0 0.1841 \
  --panel 5000 5000 0.00002 0.1575 \
  --panel 5000 5000 0.0001 0.0936 \
  --panel 5000 5000 0.0002 0.0574 \
